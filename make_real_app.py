...
# 2. AndroidManifest.xml (Bật PIP & Quyền Internet)
...
# 3. MainActivity.java (Engine WebView Thực Sự)
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // User-Agent Chrome Mobile chuẩn để Đăng nhập Google không bị báo Lỗi Trình duyệt không an toàn
        ...
        myWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                // SCRIPT TỰ ĐỘNG CHẶN CLEAN QUẢNG CÁO YOUTUBE
    ...
    protected void onUserLeaveHint() {
        ...
        // Bật chế độ Picture-in-Picture (PIP) khi thoát ra màn hình chính
        try {
...
# 4. index.html (Nơi chứa UI Setup + YouTube Thật)
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; -webkit-tap-highlight-color: transparent; }
        ...
        .bottom-nav {
            position: fixed; bottom: 12px; left: 12px; right: 12px; height: 58px;
...
<body>
    ...
    <div class="setup-screen" id="setupScreen">
        ...
        <div class="setup-step" id="step1">
            ...
            <div class="terms-box">
                ...
                2. Hệ thống hỗ trợ Tự động chặn Quảng cáo, Phát Nền và PIP.<br>
            </div>
    ...
    <div class="app-container">
        ...
        <!-- LOAD TRỰC TIẾP YOUTUBE CỦA GOOGLE -->
...
print(">>> ĐÃ NẠP XONG MÃ NGUỒN CHẠY THẬT!")
